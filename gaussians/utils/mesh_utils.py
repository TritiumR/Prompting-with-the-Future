...
class GaussianExtractor(object):
    ...
    @torch.no_grad()
    def reconstruction(self, viewpoint_stack, radius=None, center=None, object_gaussians=[], object_states=[]):
        """
        ...
        for i, viewpoint_cam in enumerate(self.viewpoint_stack):
            render_pkg = self.render(viewpoint_cam, self.gaussians, radius=radius, center=center, object_gaussians=object_gaussians, object_states=object_states)
